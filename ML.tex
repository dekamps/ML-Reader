...
%%
% Book metadata
\title{Machine Learning \\ (\lowercase{v}1.1) \\ V\lowercase{ery rough version}.\\ S\lowercase{ee }I\lowercase{ntroduction}.}
\author[M. de Kamps]{Marc de Kamps}
...
%%% Patch produced by Kevin Godby for correct appendix handling
...
\mainmatter
    ...
    tabsize=3,
    %frame=lines,                                                                                                                                                                   
    caption=Overview  of Simulation File,
    label=code:sample,
    frame=shadowbox,
...
\includechapter{unit1}{unit1.tex}
\includechapter{unit2}{unit2.tex}
\includechapter{unit3}{unit3.tex}
\includechapter{unit4}{unit4.tex}
\includechapter{unit5}{unit5.tex}
